...
public class Agenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextServico.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Consulta", "Retorno", "Avaliação" }));
        ...
        TableAgendamentos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "Alan", "Consulta", "100", "22/04/2018", "08:00", ""},
                {"2", "Abigail", "Consulta", "100", "22/04/2018", "09:00", "Pode se Atrazar um pouco"},
                {"3", "Pedro", "Retorno", "50", "23/04/2018", "08:00", null},
                {"4", "Teste", "Avaliação", "30", "23/04/2018", "09:00", null}
            },
            new String [] {
        ...
        getContentPane().add(LabelAgendaPainelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, -130, 1070, 630));

        LabelAgendaFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/imagens/AgendaFundo.png"))); // NOI18N
        getContentPane().add(LabelAgendaFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 1300, 1000));
